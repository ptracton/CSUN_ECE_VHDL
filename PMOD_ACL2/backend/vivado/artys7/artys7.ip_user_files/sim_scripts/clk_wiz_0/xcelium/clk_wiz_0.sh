...
#
# Script generated by Vivado on Sat Dec 14 06:56:44 PST 2024
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ptracton/CSUN/CSUN_ECE_VHDL/PMOD_ACL2/backend/vivado/artys7/artys7.cache/compile_simlib/xcelium"
  fi
