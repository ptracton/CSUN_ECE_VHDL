...
class SerialPortUI(PySide6.QtCore.QObject):
    """This is a UI class for managing serial port FPGA communications."""

    # connectButtonSignal = PySide6.QtCore.pyqtSignal()
    ...
    def disconnectClicked(self):
        """Handle when the disconnect button is clicked."""
